...
namespace Mil.AirForce.Loki.WebApi.Providers
{
	/// <summary>
	/// Service provider class for OAuth logins.
	/// </summary>
	public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
	{
		...
		/// </summary>
		/// <param name="publicClientId">A String value containing the provider public client ID.</param>
		/// <exception cref="ArgumentNullException">Thrown if publicClientId is null.</exception>
		...
		/// <summary>
		/// Gets the authentication properties for the login.
		/// </summary>
		/// <param name="userName">A String value containing the user name.</param>
		/// <returns>An AuthenticationProperties instance containing the properties for the login.</returns>
